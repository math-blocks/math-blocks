...
const object = (properties, options) => {
    ...
    const additionalProperties =
        (options && options.additionalProperties) || true;
...
const NumericExpression = Expression; // ref("NumericExpression");
const LogicExpression = Expression; // ref("LogicExpression");
const SetExpression = Expression; // ref("SetExpression");
    ...
    definitions: {
        ...
        Ident: node(
            "identifier",
            {
                ...
                // TODO: units
                // It's possible that variables could have units associated with
                // them as well it seems like a bit of an edge case though.
            },
            {optional: ["subscript"]},
        ),
        Num: node("number", {
        ...
        // I'm not sure how useful having a special node for this is given we'll
        // have a separate table for looking up the value of variables, constants,
        // and other things that can be defined include functions
        // type FuncDef = {
        //     type: "funcdef",
