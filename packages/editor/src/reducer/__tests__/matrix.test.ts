...
describe('matrix', () => {
  ...
  describe('DeleteRow', () => {
    test('deleting the first row', () => {
      ...
      const row = zipperToRow(state.zipper);
      expect(row.children).toEqualEditorNodes([
        builders.matrix([[builders.char('c')], [builders.char('d')]], 2, 1),
      ]);
    });
    ...
    test('deleting the last row', () => {
      ...
      const row = zipperToRow(state.zipper);
      expect(row.children).toEqualEditorNodes([
        builders.matrix([[builders.char('a')], [builders.char('b')]], 2, 1),
      ]);
    });
  ...
  describe('DeleteColumn', () => {
    test('deleting the first column', () => {
      ...
      const row = zipperToRow(state.zipper);
      expect(row.children).toEqualEditorNodes([
        builders.matrix([[builders.char('b')], [builders.char('d')]], 1, 2),
      ]);
    });
    test('deleting the last column', () => {
      ...
      const row = zipperToRow(state.zipper);
      expect(row.children).toEqualEditorNodes([
        builders.matrix([[builders.char('a')], [builders.char('c')]], 1, 2),
      ]);
    });
