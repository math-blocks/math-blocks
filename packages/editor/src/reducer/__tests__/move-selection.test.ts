  ...
  describe('frac in a row', () => {
    test('moving out of the fraction', () => {
      const startZipper: Zipper = {
        row: zrow(
          [],
          builders.row([frac('1', '2'), builders.char('+'), builders.char('3')])
            .children,
        ),
        breadcrumbs: [],
      };
    ...
    test('selecting to the right edge of the bottom breadcrumb', () => {
      ...
      state = moveRight(moveRight(moveRight(moveRight(moveRight(state)))));
    ...
    test('expanding selection out of the inner fraction', () => {
      const startZipper: Zipper = {
        row: zrow(
          ...
          builders.row([
            builders.frac(
              [frac('1', '2'), builders.char('+'), builders.char('3')],
              [builders.char('x')],
            ),
            builders.char('+'),
            builders.char('4'),
...
describe('moveLeft w/ selecting = true', () => {
  ...
  describe('frac in a row', () => {
    test('moving out of the fraction', () => {
      const startZipper: Zipper = {
        row: zrow(
          builders.row([builders.char('1'), builders.char('+'), frac('2', '3')])
            .children,
          [],
        ),
        breadcrumbs: [],
      ...
      const startZipper: Zipper = {
        row: zrow(
          builders.row([
            ...
            builders.frac(
              [builders.char('x')],
              [builders.char('2'), builders.char('+'), frac('3', '4')],
            ),
          ]).children,
          [],
        ),
