...
const enterFromRight = (cursor: Cursor, row: Row, index: number): Cursor => {
    return {
...
const exitToLeft = (cursor: Cursor, grandparentRow: Row): Cursor => {
...
const moveToPrevPibling = (cursor: Cursor, row: Row, index: number): Cursor => {
    return {
