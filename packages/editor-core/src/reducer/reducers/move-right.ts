...
const enterFromLeft = (cursor: Cursor, row: Row, index: number): Cursor => {
    return {
...
const exitToRight = (cursor: Cursor, grandparentRow: Row): Cursor => {
...
const moveToNextPibling = (cursor: Cursor, row: Row, index: number): Cursor => {
    return {
