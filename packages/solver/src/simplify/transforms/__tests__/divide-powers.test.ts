...
describe('dividePowers', () => {
  ...
  test.each`
    ...
    ${'\\frac{x^2}{x^3}'}             | ${'x^{2-3}'}
    ${'\\frac{x^2}{x^{-3}}'}          | ${'x^{2--3}'}
    ${'\\frac{x^2 y^n}{x^3 y^m}'}     | ${'x^{2-3}y^{n-m}'}
    ${'\\frac{x x^2}{x^3}'}           | ${'x^{1+2-3}'}
    ${'\\frac{x^2}{x x^3}'}           | ${'x^{2-1-3}'}
    ${'\\frac{x^2 x^n}{x^3 x^m}'}     | ${'x^{2+n-3-m}'}
    ${'\\frac{(x + 1)^2}{(x + 1)^3}'} | ${'(x+1)^{2-3}'}
    ${'\\frac{(x + 1)^2}{(1 + x)^3}'} | ${'(x+1)^{2-3}'}
    ${'\\frac{x^2 y}{x^3}'}           | ${'x^{2-3}y'}
