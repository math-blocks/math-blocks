...
describe('mulBothSides', () => {
  ...
  it('should multiple both sides (variable on right)', () => {
    const before = parseNumRel('5=\\frac{x}{2}');
    const step = transform(before);
  ...
  it('should multiple all terms (right)', () => {
    const before = parseNumRel('\\frac{x}{2}=a+b');
    const step = transform(before);
  ...
  it('should multiple all terms (left)', () => {
    const before = parseNumRel('a+b=\\frac{x}{2}');
    const step = transform(before);
  ...
  test.each`
    input                | output
    ${'\\frac{x}{2}<5'}  | ${'\\frac{x}{2}*2\\lt5*2'}
    ${'\\frac{x}{2}>5'}  | ${'\\frac{x}{2}*2\\gt5*2'}
    ${'\\frac{x}{2}≤5'}  | ${'\\frac{x}{2}*2\\leq5*2'}
    ${'\\frac{x}{2}≥5'}  | ${'\\frac{x}{2}*2\\geq5*2'}
    ${'5<\\frac{x}{2}'}  | ${'5*2\\lt\\frac{x}{2}*2'}
    ${'5>\\frac{x}{2}'}  | ${'5*2\\gt\\frac{x}{2}*2'}
    ${'5≤\\frac{x}{2}'}  | ${'5*2\\leq\\frac{x}{2}*2'}
    ${'5≥\\frac{x}{2}'}  | ${'5*2\\geq\\frac{x}{2}*2'}
    ${'\\frac{x}{-2}<5'} | ${'\\frac{x}{-2}*-2\\gt5*-2'}
    ${'\\frac{x}{-2}>5'} | ${'\\frac{x}{-2}*-2\\lt5*-2'}
    ${'\\frac{x}{-2}≤5'} | ${'\\frac{x}{-2}*-2\\geq5*-2'}
    ${'\\frac{x}{-2}≥5'} | ${'\\frac{x}{-2}*-2\\leq5*-2'}
